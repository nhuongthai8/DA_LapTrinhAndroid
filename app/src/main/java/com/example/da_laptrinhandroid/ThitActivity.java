...
import com.example.da_laptrinhandroid.Adapter.AdapterThit;
...
public class ThitActivity extends AppCompatActivity {

    Toolbar toolbartp;
    ListView listViewtp;
    AdapterThit adapterThit;
    ArrayList<SanPham> arrayThit;
    ...
    private void LoadData() {
        listViewtp.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("thongtinsp",arrayThit.get(i));
    ...
    private void GetData(int Page) {
        ...
        String path = Server.pathSPThit+String.valueOf(Page);
                ...
                if(response!=null &&response.length() != 2){
                    ...
                    try {
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            arrayThit.add(new SanPham(id,tensp,giatien,noidung,soluong,dvt,hinhsp,idlsp));
                            adapterThit.notifyDataSetChanged();
                        }
    ...
    private void Mapping(){
        ...
        arrayThit = new ArrayList<>();
        adapterThit = new AdapterThit(getApplicationContext(),arrayThit);
        listViewtp.setAdapter(adapterThit);
        //progress bar
